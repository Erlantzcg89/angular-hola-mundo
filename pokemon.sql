...
-- Volcando datos para la tabla pokemon_db.pokemons: ~4 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `pokemons_habilidades` (
  ...
  CONSTRAINT `fkPokemon` FOREIGN KEY (`id_pokemon`) REFERENCES `pokemons` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla pokemon_db.pokemons_habilidades: ~10 rows (aproximadamente)
